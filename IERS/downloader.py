...
# year, (year_roman, file_count)
  ...
  2024: ('xxxvii',   52),
  2025: ('xxxviii',  52),
  2026: ('xxxix',    30), # As of 2026-Jul-26 PST, 30 files are available for 2026.
}
...
BULLETIN_B_LAST_FILE_NUMBER  = 461
...
BULLETIN_C_LAST_FILE_NUMBER  = 72
...
BULLETIN_D_LAST_FILE_NUMBER  = 146
